...
\begin{solution}
 ...
 ------------------------------------------------------------------
  ...
  I'm such a fucking idiot. Of course this doesn't work. $f(c_{i})=f(d_{i})=d_{i}$. Bah.. I've been stuck on this problem for
  way way too long. Maybe I'll finish this in the future. At least we have approach 1 for now.
  \\
  \\
