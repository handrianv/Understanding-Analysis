...
\begin{solution}
  \begin{enumerate}[label=(\alph*)]
    ...
    Instead, since $c > 0$, we can always choose $\delta$ small enough so that $x$ and $c$ has the same sign (say, $\frac{|c|}{2}$), which would make all of the terms in the denom positive. Then:
    ...
    Another way is to note that $\sqrt[3]{x^2} + \sqrt[3]{xc} + \sqrt[3]{c^2}$ is a quadratic that's always positive with minimum at $\frac{3}{4}\sqrt[3]{c^2}$.
